/**
:q * Copyright (c) 2006-2010 MoVe - Laboratoire d'Informatique de Paris 6 (LIP6).
 ...
 */
public class SNBExport implements IGrMLExport {
	...
	private StringTemplate exportGraph(IGraph graph, String fmlUrl, IProgressMonitor monitor) throws ExtensionException {
		monitor.beginTask("Export to GrML", 1 + graph.getNodes().size() + graph.getArcs().size());
