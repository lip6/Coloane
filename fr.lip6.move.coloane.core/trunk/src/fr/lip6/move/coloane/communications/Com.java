...
public class Com implements IComUi, IComApi, IComMotor {
	 ...
	 * @param theMotor
	 */
	public final void setMotor(IMotorCom theMotor) {
		this.motor = theMotor;
	}
	 ...
	 */
	public final void setUi(IUiCom theUi) {
		this.ui = theUi;
	}
	 ...
	 */
	public final boolean authentication(String login, String pass, String ip, int port)  throws Exception {
		try {
	 ...
	 * @throws Exception
	 */
	public final boolean openSession(IModelImpl model) throws Exception {
		if (model == null) {
	 ...
	 */
	public final void drawMenu(IRootMenuCom rootMenuCom) {
		try {
	 ...
	 */
	public final void updateMenu(Vector<IUpdateMenuCom> updatesMenu) {
	 ...
	 */
	public final void drawDialog(IDialogCom dialogCom) {
	 ...
	 */
	public final void getDialogAnswers(DialogResult results) {
	 ...
	 */
	public final void setResults(String serviceName, IResultsCom resultsCom) {
	 ...
	 */
	public final void setUiMessage(int type, String text, int specialType) {
	 ...
	 */
	public final void toUpdate(int dateUpdate) {
