...
public class ConceptDetailsPage implements IDetailsPage {

	private IManagedForm mform;
	private Concept input;
	private Text conceptNametf;
//	private Text conceptEffectivetf;
	private Table requiredLabels;
...
//		rtext.setLayoutData(td);
	...
	class RequiredConceptsProvider implements IStructuredContentProvider {
