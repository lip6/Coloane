package fr.lip6.move.coloane.apiws.exceptions;
...
public class WrapperException extends Exception{
	...
	public WrapperException(String mess,int error){
		this.mess=mess;
		this.error=error;
		type = "CException";
	}
	 ...
	 */
	public WrapperException(int error, String type, String mess, int level) {
