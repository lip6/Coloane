 ...
 */
public final class RunService implements IApiService {
	/** Logger */
	...
	public RunService(Identifier identifier, Connection alligator) {
		...
		if (this.service == null) {
			...
			try {
				LOGGER.info("Description of configured service '" + identifier + "' is not locally available, asking alligator server.");
				this.service = alligator.getServices().getDescription(identifier);
	...
	private static IFile fromFile(File file) {
				...
				if (parameter.isInput()) {
					if (parameter instanceof ModelParameter) {
						...
						p.setFile(temp);
							...
							((ForeignModelParameter) parameter).getType().equalsIgnoreCase("lola")) {
