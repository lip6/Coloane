...
public class ModelHandler extends DefaultHandler {
	...
	public final void startElement(String uri, String localName, String baliseName, Attributes attributes) throws SAXException {
		...
		if (baliseName.equals("file")) {
			this.currentObject = "file";
		}else if (baliseName.equals("model")) { //$NON-NLS-1$
...
//------------------			//********** Debut Rajout **************
			...
			this.model.setSchema(attributes.getValue("xsi:noNamespaceSchemaLocation")); //$NON-NLS-1$
			
			/*
			public String donneForm(baliseName,attributes){
				return this.model.setFormalism(attributes.getValue("formalism"));
