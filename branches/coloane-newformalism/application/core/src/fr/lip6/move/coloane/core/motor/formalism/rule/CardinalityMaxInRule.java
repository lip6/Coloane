...
/**
 * Regle de Cardinalité du maximum d'arcs que peut recevoir un noeud
 */
public class CardinalityMaxInRule implements IRule{
	...
	public CardinalityMaxInRule(ElementFormalism eltIn,int maximumIn,ElementFormalism eltOut) {
	...
	*/
	public boolean canConnect(INodeImpl elemIn,INodeImpl elemOut){
		if ( elemOut.getTargetArcs().size() >= maximumIn ) {
			return false;
		}
		return true;
	}
