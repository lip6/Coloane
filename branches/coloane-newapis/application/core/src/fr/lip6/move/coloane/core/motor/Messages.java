...
public final class Messages extends NLS {
	...
	public static String Motor_5;
	public static String Motor_6;
	public static String Motor_7;
	public static String Motor_8;
	public static String Motor_9;
	static {
