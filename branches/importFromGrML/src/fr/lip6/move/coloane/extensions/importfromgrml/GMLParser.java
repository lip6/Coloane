...
/**
 * A parser for models formatted as GrML
 * @author Elodie Banel
 *
 */
public class GrMLParser {
	...
	/**
	 * The constructor for a GrML parser.
	 * @param graph The graph to be populated by the GrML analysis
	 */
	public GrMLParser(IGraph graph){
		this.graph = graph;
