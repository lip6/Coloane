...
public class NodeGraphicInfo implements ICoreNodeGraphicInfo {
	...
	public final int getWidth() {
		return (this.node.getNodeFormalism().getWidth() * scale) / 100;
	}
	...
	public final int getHeight() {
		return (this.node.getNodeFormalism().getHeight() * scale) / 100;
	}
	...
	public final int getFigureStyle() {
		return this.node.getNodeFormalism().getNumFigure();
	}
	...
	public final boolean isFilled() {
		return this.node.getNodeFormalism().getIsFilled();
	}
