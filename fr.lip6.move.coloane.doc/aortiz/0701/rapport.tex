...
\par
Conernant les boîtes de dialogue et les menus, j'ai écrit des plugins
d'exemple pour Eclipse, qui sont disponibles sur le svn à l'adresse
https://srcdev.lip6.fr/svn/research/jbvoron/projets/coloane/examples.


\section{Les boîtes de dialogue}
\par
Les classes des boîtes de dialogues sont situées dans le
package fr.lip6.move.coloane.dialogs.\\
La création des boîtes de dialogues se fait à travers la
...
ce qu'il avait à faire avec, 
Les codes numériques utilisés sont les même que ceux de
...
permet de désactiver des éléments de menu par défaut. Ces
...
Avec un peu de recul, la classe Action me paraît plus appropriée
