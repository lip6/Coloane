...
print GAR "\\oddsidemargin=-0.25cm \n";
print GAR "\\headsep=-1cm \n";
print GAR "\\textwidth 16cm \n";
print GAR "\\textheight 24cm \n";
print GAR " \n";	
print GAR "\\begin{document} \n";
print GAR "	 \n";                
print GAR "	%%% ENTETE %%%  \n";
print GAR "	\\noindent \\rule{16cm}{0.05cm}\\\\[0.25cm] \n";
print GAR "	\\noindent \n"; 
...
print GAR "	\\begin{center} \n";
print GAR "	\\begin{tabularx}{16cm}{|p{2.5cm}|p{2cm}|p{3.5cm}|X|} \n";
print GAR "	\\hline \n";
