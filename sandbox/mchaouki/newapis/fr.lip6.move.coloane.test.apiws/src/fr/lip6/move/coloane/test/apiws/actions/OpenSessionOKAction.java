...
public class OpenSessionOKAction implements IWorkbenchWindowActionDelegate {
	...
	public void run(IAction action) {
		...
		try {
			...
			if (editor == null){
				MessageDialog.openInformation(window.getShell(), "OPEN SESSION OK", "Pas d'editeur");
				return;
			}
			...
			MessageDialog.openInformation(window.getShell(), "OPEN SESSION OK", ""+sessionInfo.getResultatCalcule());
