 ...
 */
public final class SingleChoiceDialogConstructor
    implements ItemDialog<SingleChoiceParameter> {
    ...
    public SingleChoiceDialogConstructor(final ParametersPage page, final Composite parent,
                                         final SingleChoiceParameter parameter) {
        ...
        if (parameter.isActualParameter()) {
            ...
            combo.select(Math.max(0, parameter.getChoices()
                                              .indexOf(parameter.getDefaultValue())));
        }
    ...
    public
        ...
        if (combo.getText()
            ...
            combo.setBackground(combo.getDisplay()
    ...
    public
        ...
        SingleChoiceParameter that = SingleChoiceParameter.of(parameter);
        if (this.parameter.equals(that)) {
            combo.setBackground(null);
        } else {
            combo.select(Math.max(0, that.getChoices()
                                         .indexOf(that.getValue())));
            combo.setBackground(combo.getDisplay()
    ...
    @Override
    public
        SingleChoiceParameter getParameter() {
        return parameter;
    }
