 ...
 */
public final class IntegerDialogConstructor
    implements ItemDialog<IntegerParameter> {
    ...
    public
        ...
        try {
            ...
            page.addError(this, "For parameter '" + parameter.getName() + "', value '" + input.getText() +
                                "' must be an integer.");
    ...
    public
        ...
        IntegerParameter that = IntegerParameter.of(parameter);
