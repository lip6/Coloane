...
public final class RefreshAllService
    ...
    public RefreshAllService(List<Connection> connections) {
    ...
    public
        ...
        for (Connection connection : connections) {
            LOGGER.info("Refreshing menu for " + connection.getName());
            connection.wakeUp();
        }
    ...
    public
        ...
        return "Refreshes all alligators menu";
    }
