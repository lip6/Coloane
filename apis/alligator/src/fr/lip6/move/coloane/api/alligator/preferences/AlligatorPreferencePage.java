...
public class AlligatorPreferencePage extends FieldEditorPreferencePage implements IWorkbenchPreferencePage {
	 ...
	 * @param s The string to unprotect
	 ...
	 */
	public class AlligatorListEditor extends TableFieldEditor {
		...
		@Override
		protected final String[][] parseString(String stringList) {
		...
		@Override
		protected final String createList(String[][] items) {
	 ...
	 */
	public static List<Data> fromPreferences() {
		String s = Activator.getDefault().getPreferenceStore().getString(PreferenceConstants.P_ALLIGATOR_LIST);
