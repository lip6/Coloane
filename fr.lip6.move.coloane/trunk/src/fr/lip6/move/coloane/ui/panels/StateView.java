...
public class StateView extends ViewPart {
	 ...
	 * 
	 * @param parent
	 *            Interface Composite, pour la création de la visionneuse et des controls
	 * 
	...
	private void hookContextMenu() {
		...
		menuMgr.addMenuListener(new IMenuListener() {
			public void menuAboutToShow(IMenuManager manager) {
				StateView.this.fillContextMenu(manager);
			}
		});
	...
	private void createActions() {
		...
		copyAction = new Action() {
			public void run() {
				StateView.this.viewer.doOperation(ITextOperationTarget.COPY);
			};

			public boolean isEnabled() {
				return StateView.this.viewer
