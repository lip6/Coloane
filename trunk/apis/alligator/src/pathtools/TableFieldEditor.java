...
/**
 * An abstract field editor that manages a table of input values. The editor displays a table containing the rows of values,
 * buttons for adding, duplicating and removing rows and buttons to adjust the order of rows in the table. The table also allows
...
public abstract class TableFieldEditor
     ...
     * <p>
     * The default implementation of this method utilizes the selection index and the size of the list to toggle the enabled
     * state of the up, down and remove buttons.
     * </p>
     * <p>
